Namespace Items
    ...
    Public Class Berry
        ...
        Public Const WINTERGROW As Integer = 0
        Public Const SPRINGGROW As Integer = 3
        Public Const SUMMERGROW As Integer = 2
        Public Const FALLGROW As Integer = 1
        ...
        Protected Overrides Sub LoadTexture()
            _texture = TextureManager.GetTexture("Berries", _textureRectangle)
        End Sub
