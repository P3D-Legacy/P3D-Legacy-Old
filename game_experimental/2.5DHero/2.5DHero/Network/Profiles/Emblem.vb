...
#Region "EmblemHelperFunctions"
        ...
        Public Shared Function GetEmblemBackgroundTexture(ByVal emblemName As String) As Texture2D
            ...
            Return Content.Load(Of Texture2D)("SharedResources\Textures\UI\GameJolt\Emblems\" & emblemName)
        End Function
...
#Region "OnlineSprites"
        ...
        Public Shared Function GetOnlineSprite(ByVal GameJoltID As String) As Texture2D
            ...
            If Not t Is Nothing Then
                ...
                End If
            Else
                Logger.Debug("135", "GetOnlineSprite.vb: Getting sprite for " & GameJoltID & " failed.")
            End If
...
#Region "Trophy"
        ...
        Public Shared Sub DrawNewEmblems()
            If displayEmblemDelay > 0.0F Then
                ...
                Dim desText As String = achieved_emblem_description.Crop(FontManager.MiniFont, 300)
