Namespace GameJolt
    ...
    Public Class GamejoltSave
        ...
        Private Sub DownloadFailedHandler(ByVal ex As Exception)
            ...
            Logger.Log("235", Logger.LogTypes.Warning, "The download of a GameJolt save failed with this message: " & ex.Message)
        End Sub
...
#Region "DefaultData"
        ...
        'This data is hard coded into the game, it represents the default data for all GameJolt profiles:
