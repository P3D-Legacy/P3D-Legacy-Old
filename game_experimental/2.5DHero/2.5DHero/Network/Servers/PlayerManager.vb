...
Namespace Servers
    ...
    Public Class PlayerManager
        ...
        Public Sub Reset()
            Logger.Debug("145", "PlayerManager.vb: Reset PlayerManager")
...
#Region "PlayerDataPackage"
        ...
        Private ReadOnly Property GetPlayerPositionString() As String
            Get
                ...
                If Core.Player.Temp.IsInBattle = True Then
                    PositionString = Core.Player.Temp.BeforeBattlePosition.X.ToString() & "|" & (Core.Player.Temp.BeforeBattlePosition.Y - 0.1F).ToString() & "|" & Core.Player.Temp.BeforeBattlePosition.Z.ToString()
                Else
        ...
        Private ReadOnly Property GetLevelFile() As String
            Get
                ...
                If Core.Player.Temp.IsInBattle = True Then
                    levelFile = Core.Player.Temp.BeforeBattleLevelFile
                End If
                Return levelFile
            End Get
        End Property
        ...
        Private ReadOnly Property GetFacing() As Integer
            Get
                ...
                If Core.Player.Temp.IsInBattle = True Then
                    facing = Core.Player.Temp.BeforeBattleFacing
                Else
        ...
        Private ReadOnly Property GetPokemonVisible() As String
            Get
                If Screen.Level.OverworldPokemon.Visible = True And Screen.Level.Surfing = False And Screen.Level.Riding = False And Core.Player.Temp.IsInBattle = False Then
                    Return "1"
                End If
                Return "0"
            End Get
        ...
        Private ReadOnly Property GetPokemonPosition() As String
            Get
                If Core.Player.Temp.IsInBattle = False Then
