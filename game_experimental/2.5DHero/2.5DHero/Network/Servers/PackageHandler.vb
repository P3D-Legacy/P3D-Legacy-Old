...
#Region "BaseFunctions"
        ...
        Private Shared Sub HandleDestroyPlayer(ByVal p As Package)
            If Core.ServersManager.ID = CInt(p.DataItems(0)) Then
                Logger.Log("214", Logger.LogTypes.Warning, "Server misidentification: The server tried to destroy your player connection.")
            Else
        ...
        Private Shared Sub HandleServerMessage(ByVal p As Package)
            Logger.Debug("130", "Got ServerMessage: " & p.DataItems(0))
