Public Class MysteryEventScreen
    ...
    Private Sub DownloadInformation()
        ...
        Catch ex As Exception
            Logger.Log("213", Logger.LogTypes.ErrorMessage, "MysteryEventScreen.vb: Failed to download event data!")
            finishedDownload = True
            failedDownload = True
            ...
            Else
                ...
                Else
                    ...
                    Core.SpriteBatch.DrawString(FontManager.MiniFont, "Name: " & sEvent.Name & vbNewLine & vbNewLine &
                                                 ...
                                                 sEvent.Description.Crop(FontManager.MiniFont, 300), New Vector2(512, startY + 12), Color.Black)
                End If
            End If
        End If
    End Sub
