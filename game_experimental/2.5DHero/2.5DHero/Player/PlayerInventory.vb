...
Public Class PlayerInventory
    ...
    Public Sub AddItem(ByVal ID As Integer, ByVal Amount As Integer)
        Dim newItem As Item = Pokemon3D.Item.GetItemByID(ID)
    ...
    Public Function GetMessageReceive(ByVal Item As Item, ByVal Amount As Integer) As String
        ...
        If Amount = 1 Then
            Message = Core.Player.Name & " stored it~in the " & Core.Player.Inventory.GetItemPocketChar(Item) & Item.GetItemTypeName(Item.ItemType) & " pocket."
        Else
            Message = Core.Player.Name & " stored them~in the " & Core.Player.Inventory.GetItemPocketChar(Item) & Item.GetItemTypeName(Item.ItemType) & " pocket."
        End If
        Return Message
    End Function
