...
Public Class GameController
    ...
    ''' <summary>
    ''' The current version of the Pokemon3D.
    ''' </summary>
    Public Const GAMEVERSION As String = "0.53.3"

    ''' <summary>
    ''' The number of released iterations of the Pokemon3D.
    ''' </summary>
    Public Const RELEASEVERSION As String = "91"
    ...
    ''' <summary>
    ''' If this is a future version of the Pokemon3D.
    ''' </summary>
    Public Const IS_FUTURE_VERSION As Boolean = False
