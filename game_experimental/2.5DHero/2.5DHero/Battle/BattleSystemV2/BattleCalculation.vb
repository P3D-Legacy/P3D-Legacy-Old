Namespace BattleSystem
    ...
    Public Class BattleCalculation
        ...
        Public Shared Function DetermineBattleSpeed(ByVal own As Boolean, ByVal BattleScreen As BattleScreen) As Integer
            ...
            If p.Status = Pokemon.StatusProblems.Paralyzed And p.Ability.Name.ToLower() <> "quick feet" Then
        ...
        Public Shared Function CanRun(ByVal own As Boolean, ByVal BattleScreen As BattleScreen) As Boolean
            ...
            If op.Ability.Name.ToLower() = "shadow tag" And p.Ability.Name.ToLower() <> "shadow tag" And p.IsType(Element.Types.Ghost) = False Then
                Return False
            End If
        ...
        Public Shared Function CanSwitch(ByVal BattleScreen As BattleScreen, ByVal own As Boolean) As Boolean
            ...
            If own = True Then
                If BattleScreen.OppPokemon.Ability.Name.ToLower() = "shadow tag" And BattleScreen.OwnPokemon.Ability.Name.ToLower() <> "shadow tag" And BattleScreen.OwnPokemon.IsType(Element.Types.Ghost) = False Then
                    Return False
                End If
                ...
                End If
            Else
                If BattleScreen.OwnPokemon.Ability.Name.ToLower() = "shadow tag" And BattleScreen.OppPokemon.Ability.Name.ToLower() <> "shadow tag" And BattleScreen.OppPokemon.IsType(Element.Types.Ghost) = False Then
                    Return False
                End If
