...
#Region "Fields"
    ...
    'Map properties:
    Private _terrain As Terrain = New Terrain(Pokemon3D.Terrain.TerrainTypes.Plain)
    ...
    Private _offsetTimer As New Timer()
...
#End Region
    ...
    Public Sub StartOffsetMapUpdate()
        ...
        Logger.Debug("088", "Started Offset map update")
    End Sub
    ...
    Public Sub StopOffsetMapUpdate()
        ...
        Logger.Debug("089", "Stopped Offset map update")
    End Sub
    ...
    Public Sub Load(ByVal Levelpath As String)
        ...
        Else
            Logger.Debug("090", "Don't attempt to load a levelfile.")
        End If

        'Create own player entity and OverworldPokémon entity and add them to the entity enumeration.
        OwnPlayer = New OwnPlayer(0, 0, 0, {Pokemon3D.TextureManager.DefaultTexture}, Core.Player.Skin, 0, 0, "", "Gold", 0)
    ...
    Public Sub Update()
        ...
        If GameController.IS_DEBUG_ACTIVE = True Or Core.Player.SandBoxMode = True Then
            If KeyBoardHandler.KeyPressed(Keys.R) = True And Core.CurrentScreen.Identification = Screen.Identifications.OverworldScreen Then
                ...
                Logger.Debug("091", String.Format("Reload map file: {0}", Me._levelFile))
                Me.Load(LevelFile)
            End If
        End If
    ...
    ''' </summary>
    Public Sub UpdateOffsetMap(sender As Object, eventArgs As ElapsedEventArgs)
    ...
    Private Sub UpdatePlayerWarp()
        If WarpData.DoWarpInNextTick = True Then 'If a warp event got scheduled.
            ...
            If WarpData.WarpRotations > 0 And Screen.Camera.Name = "Overworld" Then
            ...
            If IsRadioOn = True AndAlso GameJolt.PokegearScreen.StationCanPlay(Me.SelectedRadioStation) = True Then
                MusicPlayer.GetInstance().Play(SelectedRadioStation.Music, True)
            Else
                IsRadioOn = False
                ...
                Else
                    ...
                    Else
                        MusicPlayer.GetInstance().Play(MusicLoop, True)
                    End If
                End If
            End If
            ...
            Dim restplaces As List(Of String) = System.IO.File.ReadAllLines(GameModeManager.GetDataFilePath("restplaces.dat")).ToList()
