        ...
        Public Sub Copy()
            If _selectionLength > 0 Then
                ...
                Catch ex As Exception
                    Logger.Log("202", Logger.LogTypes.Message, "KeyboardInput.vb: An error occurred while copying text to the clipboard.")
                End Try
            End If
        End Sub
        ...
        Public Sub Cut()
            If _selectionLength > 0 Then
                Try
                    ...
                    Deselect()
                Catch ex As Exception
                    Logger.Log("203", Logger.LogTypes.Message, "KeyboardInput.vb: An error occurred while copying text to the clipboard.")
                End Try
            End If
        End Sub
