Namespace Security
    ...
    Public MustInherit Class HashSecureBase
        ...
        Protected Sub Assert(ByVal valueName As String, ByVal currentValue As Object, ByVal newValue As Object)
            ...
            If _properties.ContainsKey(valueName) = True Then
                If _properties(valueName) = hash Then
                    _properties(valueName) = newValue.GetHashCode()
                Else
                    Throw New MismatchingHashValuesException(valueName)
                End If
            Else
                _properties.Add(valueName, newValue.GetHashCode())
            End If
        End Sub
