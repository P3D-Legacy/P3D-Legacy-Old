Public Class NetworkPokemon
    ...
    Public Sub New(ByVal pos As Vector3, ByVal PokemonTexture As String, ByVal visible As Boolean)
        MyBase.New(pos.X, pos.Y, pos.Z, "NetworkPokemon", {Pokemon3D.TextureManager.DefaultTexture}, {0, 0}, False, 0, New Vector3(0.9F), BaseModel.BillModel, 0, "", New Vector3(1))
    ...
    Private Sub ChangeTexture()
        If Me.Texture Is Nothing Then
            ...
            Me.Texture = Pokemon3D.TextureManager.GetTexture(path)
        End If
