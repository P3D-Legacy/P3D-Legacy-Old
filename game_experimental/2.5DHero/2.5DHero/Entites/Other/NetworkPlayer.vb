Public Class NetworkPlayer
    ...
    Public Sub SetTexture(ByVal TextureID As String)
        ...
        Else
            If Pokemon3D.TextureManager.TextureExist(texturePath) = True Then
                Logger.Debug("157", "Change network texture to [" & texturePath & "]")
                ...
                Me.Texture = Pokemon3D.TextureManager.GetTexture(texturePath)
            Else
                Logger.Debug("158", "Texture fallback!")
                Me.Texture = Pokemon3D.TextureManager.GetTexture("Textures\NPC\" & FallBack(Me.NetworkID))
            End If
        End If
    End Sub
    ...
    Private Sub ChangeTexture()
        If Not Me.Texture Is Nothing Then
            ...
            If r <> lastRectangle Then
                ...
                Dim t As Texture2D = Pokemon3D.TextureManager.TextureRectangle(Me.Texture, r, 1)
                Textures(0) = t
            End If
        End If
    End Sub
    ...
    Public Sub ApplyPlayerData(ByVal p As Servers.Player)
        ...
        Catch ex As Exception
            Logger.Debug("160", "NetworkPlayer.vb: Error while assigning player data over network: " & ex.Message)
        End Try
    End Sub
