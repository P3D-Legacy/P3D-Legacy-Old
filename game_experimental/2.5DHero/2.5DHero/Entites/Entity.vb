    ...
    Protected Friend Sub LoadSeasonTextures()
        If SeasonColorTexture <> "" Then
            ...
            For Each t As Texture2D In Textures
                newTextures.Add(Pokemon3D.World.GetSeasonTexture(TextureManager.GetTexture("Textures\Seasons\" & Me.SeasonColorTexture), t))
            Next
    ...
    Public Overridable Sub UpdateEntity()
        ...
        If Not Screen.Level.World Is Nothing Then
            Select Case Screen.Level.World.EnvironmentType
                Case Pokemon3D.World.EnvironmentTypes.Outside
                    Me.Shader = SkyDome.GetEntityColor().ToVector3()
                Case Pokemon3D.World.EnvironmentTypes.Dark
