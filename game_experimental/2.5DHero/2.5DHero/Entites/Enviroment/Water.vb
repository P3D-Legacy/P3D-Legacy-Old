        ...
        If Core.GameOptions.GraphicStyle = 1 Then
            ...
            If textureData.Count >= 5 Then
                ...
                If Water.WaterTexturesTemp.ContainsKey(texturePath & "_0") = False Then
                    Water.WaterTexturesTemp.Add(texturePath & "_0", TextureManager.GetTexture(texturePath, New Rectangle(r.X, r.Y, r.Width, r.Height)))
                    Water.WaterTexturesTemp.Add(texturePath & "_1", TextureManager.GetTexture(texturePath, New Rectangle(r.X + r.Width, r.Y, r.Width, r.Height)))
                    Water.WaterTexturesTemp.Add(texturePath & "_2", TextureManager.GetTexture(texturePath, New Rectangle(r.X + r.Width * 2, r.Y, r.Width, r.Height)))
                    Water.WaterTexturesTemp.Add(texturePath & "_3", TextureManager.GetTexture(texturePath, New Rectangle(r.X + r.Width * 3, r.Y, r.Width, r.Height)))
                    Water.WaterTexturesTemp.Add(texturePath & "_4", TextureManager.GetTexture(texturePath, New Rectangle(r.X + r.Width * 4, r.Y, r.Width, r.Height)))
                    Water.WaterTexturesTemp.Add(texturePath & "_5", TextureManager.GetTexture(texturePath, New Rectangle(r.X + r.Width * 5, r.Y, r.Width, r.Height)))
                    Water.WaterTexturesTemp.Add(texturePath & "_6", TextureManager.GetTexture(texturePath, New Rectangle(r.X + r.Width * 6, r.Y, r.Width, r.Height)))
                    Water.WaterTexturesTemp.Add(texturePath & "_7", TextureManager.GetTexture(texturePath, New Rectangle(r.X + r.Width * 7, r.Y, r.Width, r.Height)))
                    Water.WaterTexturesTemp.Add(texturePath & "_8", TextureManager.GetTexture(texturePath, New Rectangle(r.X + r.Width * 8, r.Y, r.Width, r.Height)))
                    Water.WaterTexturesTemp.Add(texturePath & "_9", TextureManager.GetTexture(texturePath, New Rectangle(r.X + r.Width * 9, r.Y, r.Width, r.Height)))
                    Water.WaterTexturesTemp.Add(texturePath & "_10", TextureManager.GetTexture(texturePath, New Rectangle(r.X + r.Width * 10, r.Y, r.Width, r.Height)))
                    Water.WaterTexturesTemp.Add(texturePath & "_11", TextureManager.GetTexture(texturePath, New Rectangle(r.X + r.Width * 11, r.Y, r.Width, r.Height)))
                End If
            Else
