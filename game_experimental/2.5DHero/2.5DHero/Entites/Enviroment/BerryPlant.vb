Public Class BerryPlant
    ...
    Private Sub NewTexture()
        ...
        If Me.Phase > 1 Then
            ...
            t = Pokemon3D.TextureManager.GetTexture("Textures\Berries", r, "")
        Else
            Dim r As Rectangle
            ...
            End Select
            t = Pokemon3D.TextureManager.GetTexture("Items\ItemSheet", r, "")
        End If
    ...
    Private Shared Function GetBerryAmount(ByVal Berry As Items.Berry, ByVal Watered As Integer) As Integer
        If Watered > 0 Then
            ...
            Select Case Pokemon3D.World.CurrentSeason
                Case Pokemon3D.World.Seasons.Winter
                    seasonGrow = Items.Berry.WINTERGROW
                Case Pokemon3D.World.Seasons.Spring
                    seasonGrow = Items.Berry.SPRINGGROW
                Case Pokemon3D.World.Seasons.Summer
                    seasonGrow = Items.Berry.SUMMERGROW
                Case Pokemon3D.World.Seasons.Fall
                    seasonGrow = Items.Berry.FALLGROW
            End Select
