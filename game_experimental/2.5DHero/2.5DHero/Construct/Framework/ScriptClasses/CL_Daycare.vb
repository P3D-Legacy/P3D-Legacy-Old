...
#Region "Commands"
        ...
        Private Function M_TakeEgg(ByVal argument As String) As String
            ...
            For Each line As String In Pokemon3D.Core.Player.DaycareData.SplitAtNewline()
                ...
                Else
                    ...
                    If Not p Is Nothing Then
                        Pokemon3D.Core.Player.Pokemons.Add(p)
                    End If
                End If
            Next

            Pokemon3D.Core.Player.DaycareData = newData
        ...
        Private Function M_TakePokemon(ByVal argument As String) As String
            ...
            For Each line As String In Pokemon3D.Core.Player.DaycareData.SplitAtNewline()
                If line.StartsWith(dayCareID.ToString() & "|" & PokemonIndex.ToString() & "|") = True Then
                    ...
                    p.GetExperience(Pokemon3D.Core.Player.DaycareSteps - startStep, True)
                    Pokemon3D.Core.Player.Pokemons.Add(p)
                Else
                    If newData <> "" Then
                        newData &= vbNewLine
        ...
        Private Function M_LeavePokemon(ByVal argument As String) As String
            ...
            If Pokemon3D.Core.Player.DaycareData <> "" Then
                Pokemon3D.Core.Player.DaycareData &= vbNewLine
            End If

            Pokemon3D.Core.Player.DaycareData &= dayCareID.ToString() & "|" &
                PokemonDaycareIndex.ToString() & "|" &
                Pokemon3D.Core.Player.DaycareSteps & "|0|" &
                Pokemon3D.Core.Player.Pokemons(PokemonIndex).GetSaveData()

            Pokemon3D.Core.Player.Pokemons.RemoveAt(PokemonIndex)
