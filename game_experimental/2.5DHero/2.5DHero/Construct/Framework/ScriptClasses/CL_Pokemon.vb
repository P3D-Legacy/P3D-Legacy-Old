...
#Region "PartyManagement"
        ...
        Private Function M_Remove(ByVal argument As String) As String
            ...
            If Pokemon3D.Core.Player.Pokemons.Count - 1 >= index Then
                Pokemon3D.Core.Player.Pokemons.RemoveAt(index)
            End If
        ...
        Private Function M_Add(ByVal argument As String) As String
            ...
            If argument.StartsWith("{") = True Or argument.Remove(0, 1).StartsWith(",{") = True Then
                Dim insertIndex As Integer = Pokemon3D.Core.Player.Pokemons.Count
                ...
                Pokemon3D.Core.Player.Pokemons.Insert(insertIndex, p)
                ...
                If p.IsEgg() = False Then
                    Pokemon3D.Core.Player.PokedexData = Pokedex.ChangeEntry(Pokemon3D.Core.Player.PokedexData, p.Number, pokedexType)
                End If
            Else
                ...
                Dim catchBall As Item = Pokemon3D.Item.GetItemByID(1)
                If commas > 2 Then
                    catchBall = Pokemon3D.Item.GetItemByID(Int(argument.GetSplit(3)))
                End If
                ...
                Dim catchTrainer As String = Pokemon3D.Core.Player.Name
                ...
                Pokemon.OT = Pokemon3D.Core.Player.OT
                ...
                If isEgg = True Then
                    Pokemon.EggSteps = 1
                    Pokemon.SetCatchInfos(Pokemon3D.Item.GetItemByID(5), "obtained at")
                Else
                    Pokemon.EggSteps = 0
                End If

                Pokemon3D.Core.Player.Pokemons.Add(Pokemon)
                ...
                If Pokemon.IsEgg() = False Then
                    Pokemon3D.Core.Player.PokedexData = Pokedex.ChangeEntry(Pokemon3D.Core.Player.PokedexData, Pokemon.Number, pokedexType)
                End If
            End If
            Return Core.Null
        End Function
        ...
        Private Function M_SetAdditionalValue(ByVal argument As String) As String
            ...
            If Pokemon3D.Core.Player.Pokemons.Count - 1 >= Index Then
                Pokemon3D.Core.Player.Pokemons(Index).AdditionalData = AdditionalValue
            End If
        ...
        Private Function M_SetNickname(ByVal argument As String) As String
            ...
            If Pokemon3D.Core.Player.Pokemons.Count - 1 >= Index Then
                Pokemon3D.Core.Player.Pokemons(Index).NickName = NickName
            End If
        ...
        Private Function M_SetStat(ByVal argument As String) As String
            ...
            If Pokemon3D.Core.Player.Pokemons.Count - 1 >= Index Then
                With Pokemon3D.Core.Player.Pokemons(Index)
        ...
        Private Function M_Clear(ByVal argument As String) As String
            Pokemon3D.Core.Player.Pokemons.Clear()
        ...
        Private Function M_RemoveAttack(ByVal argument As String) As String
            ...
            If Pokemon3D.Core.Player.Pokemons.Count - 1 >= Index Then
                Dim p As Pokemon = Pokemon3D.Core.Player.Pokemons(Index)
        ...
        Private Function M_ClearAttacks(ByVal argument As String) As String
            ...
            If Pokemon3D.Core.Player.Pokemons.Count - 1 >= Index Then
                Pokemon3D.Core.Player.Pokemons(Index).Attacks.Clear()
            End If
        ...
        Private Function M_SetShiny(ByVal argument As String) As String
            ...
            If Pokemon3D.Core.Player.Pokemons.Count - 1 >= Index Then
                Pokemon3D.Core.Player.Pokemons(Index).IsShiny = isShiny
            End If
        ...
        Private Function M_ChangeLevel(ByVal argument As String) As String
            ...
            If Pokemon3D.Core.Player.Pokemons.Count - 1 >= Index Then
                Pokemon3D.Core.Player.Pokemons(Index).Level = newLevel
            End If
        ...
        Private Function M_GainEXP(ByVal argument As String) As String
            ...
            If Pokemon3D.Core.Player.Pokemons.Count - 1 >= Index Then
                Pokemon3D.Core.Player.Pokemons(Index).Experience += exp
            End If
        ...
        Private Function M_SetNature(ByVal argument As String) As String
            ...
            If Pokemon3D.Core.Player.Pokemons.Count - 1 >= Index Then
                Pokemon3D.Core.Player.Pokemons(Index).Nature = Nature
            End If
        ...
        Private Function M_Heal(ByVal argument As String) As String
            If argument = "" Then
                Pokemon3D.Core.Player.HealParty()
            Else
                If argument.Contains(",") = True Then
                    ...
                    Next
                    Pokemon3D.Core.Player.HealParty(Members.ToArray())
                Else
                    Pokemon3D.Core.Player.HealParty({Int(argument)})
                End If
            End If
        ...
        Private Function M_SetFriendShip(ByVal argument As String) As String
            ...
            Pokemon3D.Core.Player.Pokemons(index).Friendship = amount
        ...
        Private Function M_CalcStats(ByVal argument As String) As String
            Dim index As Integer = Int(argument)
            Pokemon3D.Core.Player.Pokemons(index).CalculateStats()
        ...
        Private Function M_LearnAttack(ByVal argument As String) As String
            ...
            Pokemon3D.Core.SetScreen(New LearnAttackScreen(Pokemon3D.Core.CurrentScreen, Pokemon3D.Core.Player.Pokemons(index), BattleSystem.Attack.GetAttackByID(attackID)))
        ...
        Private Function M_SetGender(ByVal argument As String) As String
            ...
            If Pokemon3D.Core.Player.Pokemons.Count - 1 >= Index And Gender >= 0 And Gender <= 2 Then
                Pokemon3D.Core.Player.Pokemons(Index).Gender = CType(Gender, Pokemon.Genders)
            End If
        ...
        Private Function M_SetAbility(ByVal argument As String) As String
            ...
            If Pokemon3D.Core.Player.Pokemons.Count - 1 >= Index Then
                Pokemon3D.Core.Player.Pokemons(Index).Ability = Ability.GetAbilityByID(abilityID)
            End If
        ...
        Private Function M_SetOT(ByVal argument As String) As String
            ...
            If Pokemon3D.Core.Player.Pokemons.Count - 1 >= Index Then
                Pokemon3D.Core.Player.Pokemons(Index).OT = OT
            End If
        ...
        Private Function M_SetItem(ByVal argument As String) As String
            Dim Index As Integer = Int(argument.GetSplit(0, ","))
            Dim newItem As Item = Pokemon3D.Item.GetItemByID(Int(argument.GetSplit(1, ",")))

            If Pokemon3D.Core.Player.Pokemons.Count - 1 >= Index Then
                Pokemon3D.Core.Player.Pokemons(Index).Item = newItem
            End If
        ...
        Private Function M_RemoveItem(ByVal argument As String) As String
            ...
            Pokemon3D.Core.Player.Pokemons(Index).Item = Nothing
        ...
        Private Function M_SetItemData(ByVal argument As String) As String
            ...
            If Pokemon3D.Core.Player.Pokemons.Count - 1 >= Index Then
                If Not Pokemon3D.Core.Player.Pokemons(Index).Item Is Nothing Then
                    Pokemon3D.Core.Player.Pokemons(Index).Item.AdditionalData = itemData
                End If
            End If
        ...
        Private Function M_SetCatchTrainer(ByVal argument As String) As String
            ...
            If Pokemon3D.Core.Player.Pokemons.Count - 1 >= Index Then
                Pokemon3D.Core.Player.Pokemons(Index).CatchTrainerName = Trainer
            End If
        ...
        Private Function M_SetCatchBall(ByVal argument As String) As String
            ...
            If Pokemon3D.Core.Player.Pokemons.Count - 1 >= Index Then
                Pokemon3D.Core.Player.Pokemons(Index).CatchBall = Pokemon3D.Item.GetItemByID(catchBall)
            End If
        ...
        Private Function M_SetCatchMethod(ByVal argument As String) As String
            ...
            If Pokemon3D.Core.Player.Pokemons.Count - 1 >= Index Then
                Pokemon3D.Core.Player.Pokemons(Index).CatchMethod = method
            End If
        ...
        Private Function M_SetCatchLocation(ByVal argument As String) As String
            ...
            If Pokemon3D.Core.Player.Pokemons.Count - 1 >= Index Then
                Pokemon3D.Core.Player.Pokemons(Index).CatchLocation = place
            End If
        ...
        Private Function M_Evolve(ByVal argument As String) As String
            ...
            Dim p As Pokemon = Pokemon3D.Core.Player.Pokemons(Int(args(0)))
            ...
            If p.CanEvolve(trigger, evolutionArg) = True Then
                Pokemon3D.Core.SetScreen(New TransitionScreen(Pokemon3D.Core.CurrentScreen,
                                                             New EvolutionScreen(Pokemon3D.Core.CurrentScreen, {Int(args(0))}.ToList(),
                                                                                 evolutionArg,
                                                                                 trigger,
        ...
        Private Function M_Reload(ByVal argument As String) As String
            ...
            If Pokemon3D.Core.Player.Pokemons.Count - 1 >= PokemonIndex Then
                Pokemon3D.Core.Player.Pokemons(PokemonIndex).ReloadDefinitions()
            End If
        ...
        Private Function M_Clone(ByVal argument As String) As String
            ...
            If Pokemon3D.Core.Player.Pokemons.Count - 1 >= PokemonIndex And Pokemon3D.Core.Player.Pokemons.Count < 6 Then
                Pokemon3D.Core.Player.Pokemons.Add(Pokemon3D.Core.Player.Pokemons(PokemonIndex))
            End If
        ...
        Private Function M_Rename(ByVal argument As String) As String
            Pokemon3D.Core.SetScreen(New NameObjectScreen(Pokemon3D.Core.CurrentScreen, Pokemon3D.Core.Player.Pokemons(Int(argument))))
...
#End Region
        ...
        Private Function M_NewRoaming(ByVal argument As String) As String
            ...
            If Pokemon3D.Core.Player.RoamingPokemonData <> "" Then
                Pokemon3D.Core.Player.RoamingPokemonData &= vbNewLine
            End If

            Pokemon3D.Core.Player.RoamingPokemonData &= data(0) & "|" & data(1) & "|" & data(2) & "|" & data(3) & "|" & data(4) & "|" & p.GetSaveData()
        ...
        Private Function M_Select(ByVal argument As String) As String
            ...
            Pokemon3D.Core.SetScreen(New ChoosePokemonScreen(Pokemon3D.Core.CurrentScreen, New Items.Balls.Pokeball, Nothing, "Choose Pokémon", canExit, canChooseFainted, canChooseEgg))
        ...
        Private Function M_SelectMove(ByVal argument As String) As String
            ...
            Pokemon3D.Core.SetScreen(New ChooseAttackScreen(Pokemon3D.Core.CurrentScreen, Pokemon3D.Core.Player.Pokemons(index), canHMMOve, canExit, Nothing))
...
#Region "PartyManagement"
        ...
        Private Function F_Number(ByVal argument As String) As String
            Dim index As Integer = Int(argument.GetSplit(0))
            Return ToString(Pokemon3D.Core.Player.Pokemons(index).Number)
        End Function
        ...
        Private Function F_Gender(ByVal argument As String) As String
            Dim index As Integer = Int(argument.GetSplit(0))
            Return ToString(CInt(Pokemon3D.Core.Player.Pokemons(index).Gender))
        End Function
        ...
        Private Function F_Data(ByVal argument As String) As String
            Dim index As Integer = Int(argument.GetSplit(0))
            Return Pokemon3D.Core.Player.Pokemons(index).GetSaveData().Replace(",", "§")
        End Function
        ...
        Private Function F_Level(ByVal argument As String) As String
            Dim index As Integer = Int(argument.GetSplit(0))
            Return ToString(Pokemon3D.Core.Player.Pokemons(index).Level)
        End Function
        ...
        Private Function F_IsEgg(ByVal argument As String) As String
            Dim index As Integer = Int(argument.GetSplit(0))
            Return ToString(Pokemon3D.Core.Player.Pokemons(index).IsEgg())
        End Function
        ...
        Private Function F_AdditionalData(ByVal argument As String) As String
            Dim index As Integer = Int(argument.GetSplit(0))
            Return Pokemon3D.Core.Player.Pokemons(index).AdditionalData
        End Function
        ...
        Private Function F_Nickname(ByVal argument As String) As String
            Dim index As Integer = Int(argument.GetSplit(0))
            Return Pokemon3D.Core.Player.Pokemons(index).NickName
        End Function
        ...
        Private Function F_HasNickname(ByVal argument As String) As String
            Dim index As Integer = Int(argument.GetSplit(0))
            Return ToString(Pokemon3D.Core.Player.Pokemons(index).NickName.Length > 0)
        End Function
        ...
        Private Function F_Name(ByVal argument As String) As String
            Dim index As Integer = Int(argument.GetSplit(0))
            Return Pokemon3D.Core.Player.Pokemons(index).OriginalName
        End Function
        ...
        Private Function F_OT(ByVal argument As String) As String
            Dim index As Integer = Int(argument.GetSplit(0))
            Return Pokemon3D.Core.Player.Pokemons(index).OT
        End Function
        ...
        Private Function F_CatchTrainer(ByVal argument As String) As String
            Dim index As Integer = Int(argument.GetSplit(0))
            Return Pokemon3D.Core.Player.Pokemons(index).CatchTrainerName
        End Function
        ...
        Private Function F_CatchBall(ByVal argument As String) As String
            Dim index As Integer = Int(argument.GetSplit(0))
            Return ToString(Pokemon3D.Core.Player.Pokemons(index).CatchBall.ID)
        End Function
        ...
        Private Function F_CatchMethod(ByVal argument As String) As String
            Dim index As Integer = Int(argument.GetSplit(0))
            Return Pokemon3D.Core.Player.Pokemons(index).CatchMethod
        End Function
        ...
        Private Function F_CatchLocation(ByVal argument As String) As String
            Dim index As Integer = Int(argument.GetSplit(0))
            Return Pokemon3D.Core.Player.Pokemons(index).CatchLocation
        End Function
        ...
        Private Function F_ItemID(ByVal argument As String) As String
            Dim index As Integer = Int(argument.GetSplit(0))
            If Pokemon3D.Core.Player.Pokemons(index).Item Is Nothing Then
                Return Core.Null
            Else
                Return ToString(Pokemon3D.Core.Player.Pokemons(index).Item.ID)
            End If
        End Function
        ...
        Private Function F_Friendship(ByVal argument As String) As String
            ...
            Return ToString(Pokemon3D.Core.Player.Pokemons(index).Friendship)
        End Function
        ...
        Private Function F_ItemName(ByVal argument As String) As String
            ...
            If Pokemon3D.Core.Player.Pokemons(index).Item Is Nothing Then
                Return Core.Null
            Else
                Return Pokemon3D.Core.Player.Pokemons(index).Item.Name
            End If
        End Function
        ...
        Private Function F_HasAttack(ByVal argument As String) As String
            ...
            For Each a As BattleSystem.Attack In Pokemon3D.Core.Player.Pokemons(index).Attacks
        ...
        Private Function F_CountAttacks(ByVal argument As String) As String
            ...
            Return ToString(Pokemon3D.Core.Player.Pokemons(index).Attacks.Count)
        End Function
        ...
        Private Function F_AttackName(ByVal argument As String) As String
            ...
            Return Pokemon3D.Core.Player.Pokemons(pokeIndex).Attacks(moveIndex).Name
        End Function
        ...
        Private Function F_IsShiny(ByVal argument As String) As String
            ...
            Return ToString(Pokemon3D.Core.Player.Pokemons(index).IsShiny)
        End Function
        ...
        Private Function F_Nature(ByVal argument As String) As String
            ...
            Return Pokemon3D.Core.Player.Pokemons(index).Nature.ToString()
        End Function
        ...
        Private Function F_IsLegendary(ByVal argument As String) As String
            ...
            Return ToString(Pokemon.Legendaries.Contains(Pokemon3D.Core.Player.Pokemons(index).Number))
        End Function
        ...
        Private Function F_Count(ByVal argument As String) As String
            Return ToString(Pokemon3D.Core.Player.Pokemons.Count)
        End Function
        ...
        Private Function F_ItemData(ByVal argument As String) As String
            ...
            Dim index As Integer = Int(argument)
            If Not Pokemon3D.Core.Player.Pokemons(index).Item Is Nothing Then
                data = Pokemon3D.Core.Player.Pokemons(index).Item.AdditionalData
            End If
            Return data
        End Function
        ...
        Private Function F_TotalEXP(ByVal argument As String) As String
            Dim index As Integer = Int(argument.GetSplit(0))
            Return ToString(Pokemon3D.Core.Player.Pokemons(index).Experience)
        End Function
        ...
        Private Function F_Status(ByVal argument As String) As String
            ...
            Return Pokemon3D.Core.Player.Pokemons(index).Status.ToString()
        End Function
        ...
        Private Function F_Type1(ByVal argument As String) As String
            Dim p As Pokemon = Pokemon3D.Core.Player.Pokemons(Int(argument))
        ...
        Private Function F_DisplayName(ByVal argument As String) As String
            Dim index As Integer = Int(argument.GetSplit(0))
            Return Pokemon3D.Core.Player.Pokemons(index).GetDisplayName()
        End Function
