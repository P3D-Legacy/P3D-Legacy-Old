...
#Region "Commands"
        ...
        Private Function M_Add(ByVal argument As String) As String
            ...
            If Converter.IsNumeric(ItemID) = False Then
                ...
                If Not item Is Nothing Then
                    Pokemon3D.Core.Player.Inventory.AddItem(item.ID, amount)
                End If
            Else
                Pokemon3D.Core.Player.Inventory.AddItem(Int(ItemID), amount)
            End If
        ...
        Private Function M_Remove(ByVal argument As String) As String
            ...
            Pokemon3D.Core.Player.Inventory.RemoveItem(Item.ID, amount)
        ...
        Private Function M_Clear(ByVal argument As String) As String
            If argument <> "" Then
                ...
                Dim amount As Integer = Pokemon3D.Core.Player.Inventory.GetItemAmount(ItemID)

                If amount > 0 Then
                    Pokemon3D.Core.Player.Inventory.RemoveItem(ItemID, amount)
                End If
            Else
                Pokemon3D.Core.Player.Inventory.Clear()
            End If
        ...
        Private Function M_MessageGive(ByVal argument As String) As String
            ...
            If Not Item Is Nothing Then
                ...
                Screen.TextBox.reDelay = 0.0F
                Screen.TextBox.TextColor = TextBox.PlayerColor
                Screen.TextBox.Show(receiveString & Pokemon3D.Core.Player.Inventory.GetMessageReceive(Item, Amount), {})
...
#Region "Constructs"
        ...
        Private Function F_Count(ByVal argument As String) As String
            ...
            Return ToString(Pokemon3D.Core.Player.Inventory.GetItemAmount(ItemID))
        End Function
        ...
        Private Function F_CountAll(ByVal argument As String) As String
            Dim c As Integer = 0
            For i = 0 To Pokemon3D.Core.Player.Inventory.Count - 1
                c += Pokemon3D.Core.Player.Inventory(i).Amount
            Next
            Return ToString(c)
        End Function
