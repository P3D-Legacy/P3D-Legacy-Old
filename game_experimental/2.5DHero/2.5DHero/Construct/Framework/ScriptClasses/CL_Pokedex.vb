...
#Region "Constructs"
        ...
        Private Function F_Caught(ByVal argument As String) As String
            If Converter.IsNumeric(argument) = True Then
                Return ToString(Pokemon3D.Core.Player.Pokedexes(Int(argument)).Obtained)
            Else
                Return ToString(Pokedex.CountEntries(Pokemon3D.Core.Player.PokedexData, {2, 3}))
            End If
        End Function
        ...
        Private Function F_Shiny(ByVal argument As String) As String
            If Converter.IsNumeric(argument) = True Then
                Return ToString(Pokemon3D.Core.Player.Pokedexes(Int(argument)).Shiny)
            Else
                Return ToString(Pokedex.CountEntries(Pokemon3D.Core.Player.PokedexData, {3}))
            End If
        End Function
        ...
        Private Function F_Seen(ByVal argument As String) As String
            If Converter.IsNumeric(argument) = True Then
                Return ToString(Pokemon3D.Core.Player.Pokedexes(Int(argument)).Seen)
            Else
                Return ToString(Pokedex.CountEntries(Pokemon3D.Core.Player.PokedexData, {1}))
            End If
        End Function
