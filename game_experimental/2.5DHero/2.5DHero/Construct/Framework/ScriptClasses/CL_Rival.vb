Namespace Construct.Framework.Classes
    ...
    Public Class CL_Rival
        ...
        Private Function M_Rename(ByVal argument As String) As String
            Pokemon3D.Core.SetScreen(
                    New NameObjectScreen(Pokemon3D.Core.CurrentScreen,
                                         ...
                                         "Silver",
                                         Sub(Name As String)
                                             Pokemon3D.Core.Player.RivalName = Name
                                         End Sub
                                        )
                                    )
        ...
        Private Function M_SetName(ByVal argument As String) As String
            Pokemon3D.Core.Player.RivalName = argument
            Return Core.Null
        End Function
        ...
        Private Function F_Name(ByVal argument As String) As String
            Return Pokemon3D.Core.Player.RivalName
        End Function
