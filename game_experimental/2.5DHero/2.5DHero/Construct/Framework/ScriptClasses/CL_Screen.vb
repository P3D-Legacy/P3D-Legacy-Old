...
#Region "New screens"
        ...
        Private Function M_StorageSystem(ByVal argument As String) As String
            Pokemon3D.Core.SetScreen(New TransitionScreen(Pokemon3D.Core.CurrentScreen, New StorageSystemScreen(Pokemon3D.Core.CurrentScreen), Color.Black, False))
        ...
        Private Function M_Apricorns(ByVal argument As String) As String
            Pokemon3D.Core.SetScreen(New ApricornScreen(Pokemon3D.Core.CurrentScreen, argument))
        ...
        Private Function M_Trade(ByVal argument As String) As String
            ...
            Pokemon3D.Core.SetScreen(New TransitionScreen(Pokemon3D.Core.CurrentScreen, New TradeScreen(Pokemon3D.Core.CurrentScreen, storeData, canBuy, canSell, currencyIndicator), Color.Black, False))
        ...
        Private Function M_TownMap(ByVal argument As String) As String
            If argument.Contains(",") = True Then
                ...
                Pokemon3D.Core.SetScreen(New TransitionScreen(Pokemon3D.Core.CurrentScreen, New MapScreen(Pokemon3D.Core.CurrentScreen, regions, 0, {"view"}), Color.Black, False))
            Else
                Dim startRegion As String = argument
                Pokemon3D.Core.SetScreen(New TransitionScreen(Pokemon3D.Core.CurrentScreen, New MapScreen(Pokemon3D.Core.CurrentScreen, startRegion, {"view"}), Color.Black, False))
            End If
        ...
        Private Function M_Donation(ByVal argument As String) As String
            Pokemon3D.Core.SetScreen(New DonationScreen(Pokemon3D.Core.CurrentScreen))
        ...
        Private Function M_Blackout(ByVal argument As String) As String
            Pokemon3D.Core.SetScreen(New TransitionScreen(Pokemon3D.Core.CurrentScreen, New BlackOutScreen(Pokemon3D.Core.CurrentScreen), Color.Black, False))
        ...
        Private Function M_Credits(ByVal argument As String) As String
            ...
            Pokemon3D.Core.SetScreen(New CreditsScreen(Pokemon3D.Core.CurrentScreen))
            CType(Pokemon3D.Core.CurrentScreen, CreditsScreen).InitializeScreen(ending)
        ...
        Private Function M_HallOfFame(ByVal argument As String) As String
            If argument <> "" Then
                Pokemon3D.Core.SetScreen(New TransitionScreen(Pokemon3D.Core.CurrentScreen, New HallOfFameScreen(Pokemon3D.Core.CurrentScreen, Int(argument)), Color.Black, False))
            Else
                Pokemon3D.Core.SetScreen(New TransitionScreen(Pokemon3D.Core.CurrentScreen, New HallOfFameScreen(Pokemon3D.Core.CurrentScreen), Color.Black, False))
            End If
        ...
        Private Function M_TeachMoves(ByVal argument As String) As String
            ...
            If args.Length = 1 Then
                ...
                Pokemon3D.Core.SetScreen(New TeachMovesScreen(Pokemon3D.Core.CurrentScreen, Int(argument)))
            ElseIf args.Length > 1 Then
                ...
                Pokemon3D.Core.SetScreen(New TeachMovesScreen(Pokemon3D.Core.CurrentScreen, pokeIndex, moves.ToArray()))
            End If
        ...
        Private Function M_MailSystem(ByVal argument As String) As String
            Pokemon3D.Core.SetScreen(New TransitionScreen(Pokemon3D.Core.CurrentScreen, New MailSystemScreen(Pokemon3D.Core.CurrentScreen), Color.White, False))
        ...
        Private Function M_Input(ByVal argument As String) As String
            ...
            Pokemon3D.Core.SetScreen(New InputScreen(Pokemon3D.Core.CurrentScreen, defaultName, inputMode, currentText, MaxChars, textureList))
        ...
        Private Function M_MysteryEvent(ByVal argument As String) As String
            Pokemon3D.Core.SetScreen(New TransitionScreen(Pokemon3D.Core.CurrentScreen, New MysteryEventScreen(Pokemon3D.Core.CurrentScreen), Color.White, False))
