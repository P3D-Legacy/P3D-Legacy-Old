...
#Region "Commands"
        ...
        Private Function M_SetRenderDistance(ByVal argument As String) As String
            Select Case argument.ToLower()
                Case "0", "tiny"
                    Pokemon3D.Core.GameOptions.RenderDistance = 0
                Case "1", "small"
                    Pokemon3D.Core.GameOptions.RenderDistance = 1
                Case "2", "normal"
                    Pokemon3D.Core.GameOptions.RenderDistance = 2
                Case "3", "far"
                    Pokemon3D.Core.GameOptions.RenderDistance = 3
                Case "4", "extreme"
                    Pokemon3D.Core.GameOptions.RenderDistance = 4
            End Select
