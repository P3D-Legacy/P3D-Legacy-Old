...
#Region "Commands"
        ...
        Private Function M_UseRepel(ByVal argument As String) As String
            ...
            Select Case itemID
                ...
                Case 43
                    steps = 250
            End Select
            Pokemon3D.Core.Player.RepelSteps += steps
        ...
        Private Function M_ReceivePokedex(ByVal argument As String) As String
            Pokemon3D.Core.Player.HasPokedex = True
            ...
            For Each p As Pokemon In Pokemon3D.Core.Player.Pokemons
                ...
                If p.IsShiny = True Then
                    i = 3
                End If
                Pokemon3D.Core.Player.PokedexData = Pokedex.ChangeEntry(Pokemon3D.Core.Player.PokedexData, p.Number, i)
            Next
        ...
        Private Function M_ReceivePokegear(ByVal argument As String) As String
            Pokemon3D.Core.Player.HasPokegear = True
            Return Core.Null
        End Function
        ...
        Private Function M_AddMoney(ByVal argument As String) As String
            Pokemon3D.Core.Player.Money += Int(argument)
        ...
        Private Function M_GetBadge(ByVal argument As String) As String
            If Converter.IsNumeric(argument) = True Then
                If Pokemon3D.Core.Player.Badges.Contains(Int(argument)) = False Then
                    Pokemon3D.Core.Player.Badges.Add(Int(argument))
                    SoundManager.PlaySound("badge_acquired", True)
                    Screen.TextBox.TextColor = TextBox.PlayerColor
                    Screen.TextBox.Show(Pokemon3D.Core.Player.Name & " received the~" & Badge.GetBadgeName(Int(argument)) & "badge.", {}, False, False)

                    Pokemon3D.Core.Player.AddPoints(10, "Got a badge.")
                End If
            End If
        ...
        Private Function M_RemoveBadge(ByVal argument As String) As String
            If Converter.IsNumeric(argument) = True Then
                If Pokemon3D.Core.Player.Badges.Contains(Int(argument)) = True Then
                    Pokemon3D.Core.Player.Badges.Remove(Int(argument))
                End If
            End If
        ...
        Private Function M_ShowRod(ByVal argument As String) As String
            If Pokemon3D.Core.CurrentScreen.Identification = Screen.Identifications.OverworldScreen Then
        ...
        Private Function M_SetGender(ByVal argument As String) As String
            Pokemon3D.Core.Player.Male = Not Bool(argument)
        ...
        Private Function M_SetName(ByVal argument As String) As String
            Pokemon3D.Core.Player.Name = argument
        ...
        Private Function M_SetOT(ByVal argument As String) As String
            While argument.Length < 5
                argument = "0" & argument
            End While
            Pokemon3D.Core.Player.OT = argument
...
#Region "Constructs"
        ...
        Private Function F_Skin(ByVal argument As String) As String
            Return Pokemon3D.Core.Player.Skin
        End Function
        ...
        Private Function F_Money(ByVal argument As String) As String
            Return ToString(Pokemon3D.Core.Player.Money)
        End Function
        ...
        Private Function F_Name(ByVal argument As String) As String
            Return Pokemon3D.Core.Player.Name
        End Function
        ...
        Private Function F_GameJoltID(ByVal argument As String) As String
            Return Pokemon3D.Core.GameJoltSave.GameJoltID
        End Function
        ...
        Private Function F_HasPokedex(ByVal argument As String) As String
            Return ToString(Pokemon3D.Core.Player.HasPokedex)
        End Function
        ...
        Private Function F_HasPokegear(ByVal argument As String) As String
            Return ToString(Pokemon3D.Core.Player.HasPokegear)
        End Function
