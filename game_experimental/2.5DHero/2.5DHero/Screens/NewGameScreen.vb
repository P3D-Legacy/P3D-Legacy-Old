Public Class NewGameScreen
    ...
    Dim introMusic As String = "RouteMusic1"
    ...
    Public Overrides Sub Update()
        ...
        If ProfAlpha < 255 And Index = 0 Then
            ...
            If ProfAlpha >= 255 Then
                MusicPlayer.GetInstance().Play(Me.introMusic, True, 0.0F, 0.0F)
            End If
        ...
        Dim diffR As Byte = 5
        If (CInt(currentBackColor.R) - Math.Abs(CInt(AimColor.R))) < 5 Then
            diffR = 1
        End If
        Dim diffG As Byte = 5
        If (CInt(currentBackColor.G) - Math.Abs(CInt(AimColor.G))) < 5 Then
            diffG = 1
        End If
        Dim diffB As Byte = 5
        If (CInt(currentBackColor.B) - Math.Abs(CInt(AimColor.B))) < 5 Then
            diffB = 1
        End If
