...
Public Class NewInventoryScreen
    ...
    Private Sub DrawInfo(ByVal preBatch As SpriteBatch, ByVal preTarget As RenderTarget2D)
        ...
        infoBatch.DrawString(FontManager.TextFont, itemDescription.Crop(FontManager.TextFont, 1.0F, 430), New Vector2(28, 84), Color.LightGray, 0F, Vector2.Zero, 1.0F, SpriteEffects.None, 0F)
