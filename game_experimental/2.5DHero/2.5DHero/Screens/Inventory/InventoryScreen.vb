Public Class InventoryScreen
    ...
    Public Sub New(ByVal currentScreen As Screen, ByVal AllowedPages() As Integer, ByVal StartPageIndex As Integer, ByVal DoStuff As DoStuff)
        ...
        index(bagIndex) = Core.Player.Temp.InventoryItemIndicies(0)
    ...
    Public Overrides Sub Update()
        ...
        Core.Player.Temp.InventoryTabIndex = Me.bagIndex
        Core.Player.Temp.InventoryItemIndicies(0) = Me.index(bagIndex)
        ...
        For i As Integer = 0 To cItems.Keys.Count - 1
            ...
            If i + scrollIndex(bagIndex) <= 5 And i + scrollIndex(bagIndex) >= 0 Then
                ...
                With Core.SpriteBatch
                    ...
                    If i = index(bagIndex) Then
                        .DrawString(FontManager.MiniFont, Item.Description.Crop(FontManager.MiniFont, 450), New Vector2(80, 534), Color.Black)
                    End If
                End With
            End If
        Next
