Public Class ApricornScreen
    ...
    Private Sub ClearApricorns(ByVal sender As ButtonIcon)
        Me.Apricorns = {"0", "0", "0", "0", "0", "0", "0"}.ToList()

        AdjustButtonTexts()
    End Sub

    Private Sub Give(ByVal sender As ButtonIcon)
        Me.State = States.Wait
    ...
    Private Sub Take(ByVal sender As ButtonIcon)
        Me.State = States.CanGive
