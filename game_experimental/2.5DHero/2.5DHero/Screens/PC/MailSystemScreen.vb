Public Class MailSystemScreen
    ...
    Public Overrides Sub Draw()
        ...
        If message <> "" Then
            ...
            Dim t As String = message.Crop(FontManager.InGameFont, 800)
    ...
    Private Sub DrawCurrentMail()
        If index = 0 Then
            ...
            Dim text As String = ("Text: (" & mail.MailText.Length & "/" & 200 & ")" & vbNewLine & vbNewLine & mail.MailText.Replace("<br>", vbNewLine)).Crop(FontManager.MiniFont, 600)
        ...
        Else
            ...
            Dim text As String = ("Text: " & vbNewLine & vbNewLine & mail.MailText).Crop(FontManager.MiniFont, 600)
            ...
            If mail.MailAttachment > -1 Then
                ...
                Core.SpriteBatch.DrawString(FontManager.MiniFont, (t.Name & vbNewLine & vbNewLine & t.Description).Crop(FontManager.MiniFont, 500), New Vector2(510, yPlus + 340), Color.Black)
            End If
        End If
    End Sub
    ...
    Public Shared Function GetTrophyInformation(ByVal ID As Integer) As TrophyInformation
        ...
        Select Case ID
            ...
            Case 3
                ...
                T.Description = "This proves that the Kolben Support helped you with your Pokemon3D."
