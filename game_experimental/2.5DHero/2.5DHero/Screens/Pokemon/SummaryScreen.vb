Public Class SummaryScreen
    ...
    Private Sub DrawPage1()
        With GetPokemon()
            ...
            SpriteBatch.DrawString(FontManager.ChatFont, .Ability.Description.Crop(FontManager.ChatFont, 1.0F, 300), New Vector2(460, 496), New Color(255, 255, 255, CInt(220 * _fadeIn * _pageFade)))
    ...
    Private Sub DrawPage2()
        With GetPokemon()
            ...
            'Description:
            SpriteBatch.DrawString(FontManager.ChatFont, .Attacks(_moveIndex).Description.Crop(FontManager.ChatFont, 300), New Vector2(820, 336), New Color(255, 255, 255, CInt(220 * _fadeIn * _pageFade * _moveFade)))
        End With
    End Sub
