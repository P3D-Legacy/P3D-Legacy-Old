Public Class Daycare
    ...
    Public Shared Function ProduceEgg(ByVal daycareID As Integer) As Pokemon
        ...
        For Each line As String In Core.Player.DaycareData.SplitAtNewline()
            If line.StartsWith(daycareID.ToString() & "|0|") = True Then
                ...
                parent1 = Pokemon3D.Pokemon.GetPokemonByData(data)
            ElseIf line.StartsWith(daycareID.ToString() & "|1|") = True Then
                Dim data As String = line.Remove(0, line.IndexOf("{"))
                parent2 = Pokemon3D.Pokemon.GetPokemonByData(data)
        ...
        If Not parent1 Is Nothing And Not parent2 Is Nothing And EggID <> 0 Then
            ...
            If parent1.Gender = Pokemon3D.Pokemon.Genders.Male Then
                male = 0
            End If
            If parent2.Gender = Pokemon3D.Pokemon.Genders.Male Then
                male = 1
            End If
            If male > -1 Then
            ...
            If DittoAsParent = 0 Then
                ...
                If parent2.Gender = Pokemon3D.Pokemon.Genders.Female Then
                    female = parent2
                End If
    ...
    Public Shared Function CanBreed(ByVal Pokemon As List(Of Pokemon)) As Integer
        ...
        If Pokemon.Count = 2 Then
            ...
            If p1.EggGroup1 = Pokemon3D.Pokemon.EggGroups.Undiscovered Or p1.EggGroup2 = Pokemon3D.Pokemon.EggGroups.Undiscovered Or p2.EggGroup1 = Pokemon3D.Pokemon.EggGroups.Undiscovered Or p2.EggGroup2 = Pokemon3D.Pokemon.EggGroups.Undiscovered Then
                Return 0
            End If

            If p1.EggGroup1 = Pokemon3D.Pokemon.EggGroups.Ditto Or p1.EggGroup2 = Pokemon3D.Pokemon.EggGroups.Ditto Then
                If p2.EggGroup1 = Pokemon3D.Pokemon.EggGroups.Ditto Or p2.EggGroup2 = Pokemon3D.Pokemon.EggGroups.Ditto Then
                    Return 0
                End If
            End If
            ...
            ElseIf p1.IsGenderless = False And p2.IsGenderless = False Then
                If p1.Gender <> p2.Gender Then
                    If p1.EggGroup1 = Pokemon3D.Pokemon.EggGroups.Ditto Or p2.EggGroup1 = Pokemon3D.Pokemon.EggGroups.Ditto Or p1.EggGroup2 = Pokemon3D.Pokemon.EggGroups.Ditto Or p2.EggGroup2 = Pokemon3D.Pokemon.EggGroups.Ditto Then
                        chance = -1
                    Else
                        If p1.EggGroup1 = p2.EggGroup1 And p1.EggGroup1 <> Pokemon3D.Pokemon.EggGroups.None Or
                            p1.EggGroup2 = p2.EggGroup1 And p1.EggGroup2 <> Pokemon3D.Pokemon.EggGroups.None Or
                            p1.EggGroup1 = p2.EggGroup2 And p1.EggGroup1 <> Pokemon3D.Pokemon.EggGroups.None Or
                            p1.EggGroup2 = p2.EggGroup2 And p1.EggGroup2 <> Pokemon3D.Pokemon.EggGroups.None Then
                            chance = -1
                        End If
                    End If
                End If
    ...
    Public Shared Function CanBreed(ByVal daycareID As Integer) As Integer
        ...
        For Each line As String In Core.Player.DaycareData.SplitAtNewline()
            If line.StartsWith(daycareID.ToString() & "|") = True Then
                Dim data As String = line.Remove(0, line.IndexOf("{"))
                Dim p As Pokemon = Pokemon3D.Pokemon.GetPokemonByData(data)
                l.Add(p)
            End If
        Next
    ...
    Private Shared Function GetEggPokemonID(ByVal Pokemon As Dictionary(Of Integer, Pokemon)) As Integer
        If Pokemon.Count = 2 Then
            ...
            If p1.Gender = Pokemon3D.Pokemon.Genders.Female Then
                Return p1.Number
            End If
            If p2.Gender = Pokemon3D.Pokemon.Genders.Female Then
                Return p2.Number
            End If
        End If
    ...
    Private Shared Function GetEggPokeballID(ByVal Pokemon As List(Of Pokemon)) As Integer
        ...
        If Pokemon.Count = 2 Then
            ...
            End If
            'No Pokémon is Ditto:
            If p1.EggGroup1 <> Pokemon3D.Pokemon.EggGroups.Ditto And p1.EggGroup2 <> Pokemon3D.Pokemon.EggGroups.Ditto And p2.EggGroup1 <> Pokemon3D.Pokemon.EggGroups.Ditto And p2.EggGroup2 <> Pokemon3D.Pokemon.EggGroups.Ditto Then
    ...
    Public Shared Sub ObtainEgg()
        ...
        Logger.Debug("102", "Daycare circle complete!")

        For Each DaycareID As Integer In IDs
            Logger.Debug("103", "Daycare ID: " & DaycareID)
                ...
                If line.StartsWith(DaycareID & "|") = True Then
                    ...
                    Else
                        ...
                        If Pokemon.ContainsKey(PlaceID) = False Then
                            Dim p As Pokemon = Pokemon3D.Pokemon.GetPokemonByData(PokemonData)
            ...
            Logger.Debug("104", "Pokémon count: " & Pokemon.Count)
            Logger.Debug("105", "Has Egg: " & hasEgg.ToString())

            If hasEgg = False Then
                Dim breedChance As Integer = CanBreed(Pokemon)
                If breedChance > 0 Then
                    Logger.Debug("106", "Breed chance: " & breedChance)
                    If Core.Random.Next(0, 100) < breedChance Then
                        Dim parentID As Integer = GetEggPokemonID(Pokemon)

                        Dim newEggID As Integer = Pokemon3D.Pokemon.GetPokemonByID(parentID).EggPokemon
                        Dim s As String = DaycareID.ToString() & "|Egg|" & newEggID.ToString()

                        Logger.Debug("107", "Egg created!" & vbNewLine & "EggID: " & newEggID)
                    ...
                    End If
                Else
                    Logger.Debug("108", "Pokémon in Daycare " & DaycareID & " cannot breed.")
                End If
            End If
        Next
    End Sub
